...
### Run this command to compile the project. It will create an executable named `capture_service.exe`.
 `g++ -std=c++17 -I include src/*.cpp -o capture_service.exe -lws2_32`
